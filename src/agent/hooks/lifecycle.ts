 ...
 * is how the conductor learns a session ended). Logging is identical to
 * {@link createLifecycleHooks}'s Stop/StopFailure blocks; the one-shot path's
 * `createLifecycleHooks` (all four events) stays as-is until P13b.
