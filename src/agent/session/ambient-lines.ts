...
const QUOTA_GROUP_WINDOWS: Readonly<Record<string, string>> = { session: '5h', weekly: '1w' };
...
function providerQuotaData(
    ...
    const groupMatchesWindow = quota.group === undefined || QUOTA_GROUP_WINDOWS[quota.group] === window;
