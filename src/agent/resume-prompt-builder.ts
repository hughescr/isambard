 ...
 * session's human-wait escalation interrupts a running turn: just the partial-work blocks from
 * {@link buildResumePrompt}, with no events section and no new-messages section (those already
 * arrive via their own envelopes on the same session).
