...
import { buildLedgerThinkingSynopsis, createLedgerStreamEventHandler, createStreamEventHandler, type CreateLedgerStreamEventHandlerDeps, type StreamEventHandlerDeps  } from '../../../../../src/integrations/discord/presence/stream-event-handler.js';
...
describe('buildLedgerThinkingSynopsis', () => {
    ...
    it('returns the generated synopsis when the throttle allows an update', async () => {
        const generator = { generateSynopsis: mock(async (): Promise<string | null> => 'Analyzing your request'), generateCatchUpSynopsis: mock() } as unknown as DynamicStatusGenerator;
    ...
    it('returns undefined without calling generateSynopsis when the throttle window has not elapsed', async () => {
        const generator = { generateSynopsis: mock(async (): Promise<string | null> => 'some status'), generateCatchUpSynopsis: mock() } as unknown as DynamicStatusGenerator;
    ...
    it('converts a null generateSynopsis result to undefined', async () => {
        const generator = { generateSynopsis: mock(async (): Promise<string | null> => null), generateCatchUpSynopsis: mock() } as unknown as DynamicStatusGenerator;
        const throttle = makeThrottle(true);
